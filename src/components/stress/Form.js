...
import StressPage from "./Page";
import { setHasError, setEndDialogOpen } from "../../actions/stressActions";
...
const StressForm = (props) => {
  ...
  const timeUp = useSelector((state) => state.stress.timeUp);
  const endDialogOpen = useSelector((state) => state.stress.endDialogOpen);
